...
${OBJECTDIR}/_ext/1360937237/dotcode.o: ../src/dotcode.c 
	...
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/dotcode.o ../src/dotcode.c

${OBJECTDIR}/_ext/1360937237/parser.tab.o: ../src/parser.tab.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/parser.tab.o ../src/parser.tab.c

${OBJECTDIR}/_ext/1360937237/lexer.o: ../src/lexer.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/lexer.o ../src/lexer.c

${OBJECTDIR}/_ext/1360937237/parser_funcs.o: ../src/parser_funcs.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/parser_funcs.o ../src/parser_funcs.c

${OBJECTDIR}/_ext/1360937237/main.o: ../src/main.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/main.o ../src/main.c
